...
form.addEventListener("submit", function(event) {
  ...
  if (selectedBeverage) {
    ...
    messageDiv.textContent = "Пожалуйста, выберите напиток"; // Если ничего не выбрано
  }
});
/* script.js */
...
passwordForm.addEventListener("submit", function(event) {
  ...
  if (password === "пароль") {
    passwordInput.classList.remove("invalid"); // Удаляем класс ошибки
    passwordInput.classList.add("valid");      // Добавляем класс валидации
    errorMessageDiv.textContent = "";         // Очищаем сообщение об ошибке
  } else {
    passwordInput.classList.remove("valid");   // Удаляем класс валидации
    passwordInput.classList.add("invalid");    // Добавляем класс ошибки
    errorMessageDiv.textContent = "пароль неверный"; // Выводим сообщение об ошибке
  }
});